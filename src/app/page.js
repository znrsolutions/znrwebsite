    ...
    <main className={styles.home}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.container}>
          ...
          <p className={styles.sub}>Transforming payments · Reshaping finance · Reimagining retail</p>
      ...
      <section className={styles.about}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.founderImgWrap}>
            <img src="/founder.jpg" alt="Founder" className={styles.founderImg} />
            <span className={styles.founderBadge}>Founder & CEO</span>
          </div>

          <h2 className={styles.title}>"Building the infrastructure<br />that commerce runs on"</h2>

          <span className={styles.quoteMark}>"</span>

          <p className={styles.message}>
            At ZNR Solutions, we started with a simple belief that the way money moves
            should be faster, smarter, and more accessible for everyone. The finance and
            retail industries were overdue for a revolution.
          </p>
          <p className={styles.message}>
            We built ZNR to be that change. From seamless payment ecosystems to intelligent
            retail solutions, everything we do is driven by one goal: empowering businesses
          ...
          <div className={styles.grid}>
            <div className={styles.card}>
              ...
              <div className={styles.overlay}>
                <h3>Evolute</h3>
                <p>Evolute is a business consulting and outsourcing solutions provider based in Sri Lanka helping organizations improve operational efficiency.</p>

              </div>
              <a href="https://evolute.lk" target="_blank" className={styles.link}>
                <span>→</span>
              </a>
            </div>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.overlay}>
                <h3>Mr Events</h3>
                <p>MR Events is an event management platform that showcases services for corporate events, product launches, and concerts.</p>
              </div>
              <a href="https://mr-events.net/" target="_blank" className={styles.link}>
                <span>→</span>
              </a>
            </div>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.overlay}>
                <h3>Chain Reclaim</h3>
                <p>Blockchain-based fund recovery service helping victims of crypto scams recover lost digital assets.</p>
              </div>
              <a href="https://chainreclaim.com" target="_blank" className={styles.link}>
                <span>→</span>
              </a>
            </div>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.overlay}>
                ...
                <p>Online restaurant booking platform helping businesses manage reservations and customers book tables easily.</p>
              </div>
              <a href="https://www.bookmytables.co.uk/" target="_blank" className={styles.link}>
                <span>→</span>
              </a>
            </div>
            ...
            <div className={styles.card}>
              ...
              <div className={styles.overlay}>
                <h3>Minerva</h3>
                <p>Business consulting and digital solutions platform improving operational efficiency and sustainable growth.</p>
              </div>
              <a href="https://min-erva.com/" target="_blank" className={styles.link}>
                <span>→</span>
              </a>
            </div>
          </div>
      ...
      <section className={styles.cta}>
        ...
        <div className={styles.ctaContainer}>
          ...
          <h2>Ready to <em>revolutionize</em><br />your payments?</h2>

          <div className={styles.divider}></div>

          <p className={styles.sub}>
            Let's map out your team needs, technologies, and timelines — and build
            the payment infrastructure your business deserves.
          </p>

          <div className={styles.btnRow}>
            <CalendlyButton />
            <span className={styles.note}>No commitment · Free consultation</span>
          </div>
      ...
      <section className={styles.projects}>
        <div className={styles.container}>
          ...
          <div className={styles.gridProducts}>
            ...
            {/* PRIME TRADER */}
            <div className={styles.card}>
              <div className={styles.logoWrap} style={{ background: "#0f1520" }}>
                <svg width="250" height="50" viewBox="0 0 250 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <text x="8" y="38" fontFamily="Georgia, serif" fontSize="30" fontWeight="700" fill="url(#traderGrad)" letterSpacing="1.5">PRIME TRADER</text>
                  <defs>
                    <linearGradient id="traderGrad" x1="0" y1="0" x2="250" y2="0" gradientUnits="userSpaceOnUse">
              ...
              <div className={styles.overlay}>
                <h3>PRIME Trader</h3>
                <p>A next-generation trading platform delivering real-time market data, smart order execution, and advanced analytics for retail and institutional traders.</p>
              </div>
              {/* <a href="" target="_blank" className={styles.link}>
    <span>→</span>
  </a> */}
