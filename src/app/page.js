  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="ZNR Solutions builds secure fintech, retail, and cybersecurity systems. Transforming payments, reshaping finance, and redefining retail."
        />

        <meta
          name="keywords"
          content="fintech solutions, retail software, cybersecurity services, payment systems, Sri Lanka software company"
        />

        <meta name="author" content="ZNR Solutions" />

        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://znrsolutions.com" />

        {/* OPEN GRAPH */}
        <meta property="og:title" content="ZNR Solutions" />
        <meta
          property="og:description"
          content="Secure fintech, retail & cybersecurity solutions for modern businesses."
        />
        <meta property="og:url" content="https://znrsolutions.com" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/og-image.png" />

        {/* TWITTER */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="ZNR Solutions" />
        <meta
          name="twitter:description"
          content="Fintech, Retail & Cybersecurity Solutions for modern businesses."
        />
        <meta name="twitter:image" content="/og-image.png" />

        {/* ✅ ADD STRUCTURED DATA HERE (LAST) */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: ["https://linkedin.com/company/znrsolutions"],
            }),
          }}
        />
      </Head>
        ...
        <section className={styles.about}>
          <div className={styles.wrapper}>
            ...
            <div className={styles.founderImgWrap}>
              <img
                src="/founder.jpg"
                alt="Amman Lantra Founder and CEO of ZNR Solutions fintech and cybersecurity company"
            ...
            <p className={styles.message}>
              ...
              transformation, not just in efficiency, but in trust and
              resilience.
            </p>
            <p className={styles.message}>
              ...
              ecosystems evolve, so do the risks which is why cybersecurity is
              not an afterthought for us, but a core foundation of everything we
              design and deliver.
            </p>
            <p className={styles.message}>
        ...
        <section className={styles.cta}>
          ...
          <div className={styles.ctaContainer}>
            ...
            <div style={{ marginTop: "20px", textAlign: "center" }}>
              <Link href="/solutions">Explore Our Fintech Solutions</Link>
              <br />
            ...
            <div className={styles.gridProducts}>
              ...
              <div className={styles.card}>
                ...
                <div className={styles.overlay}>
                  <h3>PRIME CRM</h3>
                  <p>
                    A powerful customer relationship management platform built
              ...
              <div className={styles.card}>
                ...
                <div className={styles.overlay}>
                  <h3>PRIME Trader</h3>
                  <p>
                    A next generation trading platform delivering real time
          ...
          <div className={styles.container}>
            ...
            <div className={styles.grid}>
              ...
              >
                <img
                  src="/blog.jpg"
                  alt="Web development and digital transformation insights"
                />
                <p>
              ...
              <a
                ...
                className={styles.card}
              >
                <img src="/case.jpg" alt="Fintech and retail case studies" />
              ...
              >
                ...
                />
                <p>
                  Effective social media management goes beyond consistent
                  posting it requires strategy, insight, and measurable
                  execution.
                </p>
              ...
              >
                <img
                  src="/team1.jpg"
                  alt="Digital marketing and business growth strategies"
                />
                <p>
