    ...
    <main className={styles.retail}>
        ...
        <div className={styles.grid}>
          {features.map((f, i) => (
            <div className={styles.card} key={i}>
              <div className={styles.iconWrap} style={{ color: f.color, background: `${f.color}14` }}>
                {f.icon}
              </div>
              <h3>{f.title}</h3>
              <p>{f.desc}</p>
      ...
      <section className={styles.howItWorks}>
        <div className={styles.sectionHeader}>
          ...
          <p>A clear, structured process from first conversation to full launch.</p>
        </div>
          ...
          {steps.map((s, i) => (
            <div className={styles.step} key={i}>
              <div className={styles.stepLeft}>
                <div className={styles.circle}>{String(i + 1).padStart(2, "0")}</div>
