...
export default function Solutions() {
  ...
  const reasons = [
    { title: "Finance-First Thinking", desc: "Every solution we build is designed with financial compliance, data security, and transaction integrity at its core." },
    { title: "End-to-End Delivery", desc: "From discovery and design to development, deployment, and ongoing support — we own the full lifecycle." },
    { title: "Retail & Commerce DNA", desc: "Deep expertise in retail technology means we understand the complexity of inventory, POS, and customer experience." },
    { title: "Agile & Transparent", desc: "Weekly sprints, real-time updates, and clear communication so you always know where your project stands." },
  ];
    ...
    <main className={styles.solutions}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1>Technology that <em>Powers</em> Your Business</h1>
          <p>ZNR is your trusted partner for fintech, retail technology, and digital transformation — built to save you time, reduce costs, and accelerate growth.</p>
        </div>
      </section>
      ...
      <section className={styles.servicesSection}>
        <div className={styles.sectionHeader}>
          ...
          <p>A comprehensive suite of technology services tailored for finance, retail, and beyond.</p>
        </div>

        <div className={styles.grid}>
          {services.map((s, i) => (
            <div className={styles.card} key={i}>
              <div className={styles.iconWrap} style={{ color: s.color, background: `${s.color}14` }}>
                {s.icon}
              </div>
              <h3>{s.title}</h3>
              <p>{s.desc}</p>
      ...
      <section className={styles.why}>
        <div className={styles.whyContainer}>
          <div className={styles.whyLeft}>
            ...
            <p>We don't just build software — we build systems that drive revenue, reduce risk, and scale with your ambitions.</p>
          </div>
